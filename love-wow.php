<?php
// Script Created By MRDJ AYESH// to use this script just attach it with the simple bot script and use the iphone on that script it will get tokens from cokis
...
// Created With a lot OF <3 and Coffee ;) ( Regards : GULRAIZ REHMAN ) 
?>